...
Going beyond views about technocracy, I also examined the influence of those views on specific, **politically** controversial issues. I explored energy sources expected to garner opposition from liberal Democrats as well as climate policies expected to be opposed by conservative Republicans.  As expected, I found that, on average, an increase in support for technocracy was associated with increases in support for all energy sources and climate policies. These findings suggest that support for expert-driven decision-making is associated with support for approaches that require expert knowledge to develop, implement, and monitor.  
